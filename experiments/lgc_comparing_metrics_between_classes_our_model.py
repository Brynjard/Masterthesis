...
if __name__ == '__main__':
    ...
    plot_scores_per_class("Precision", list_of_lists_precision, f'lcg_{delta}/lgc_precision_per_class_{delta}', colors)
    plot_scores_per_class("Precision visible", list_of_lists_precision_visible, f'lcg_{delta}/lgc_precision_visible_per_class_{delta}', colors)
    plot_scores_per_class("Precision unshown", list_of_lists_precision_unshown, f'lcg_{delta}/lgc_precision_unshown_per_class_{delta}', colors)
    plot_scores_per_class("Recall", list_of_lists_recall, f'lcg_{delta}/lgc_recall_per_class_{delta}', colors)
    plot_scores_per_class("Recall visible", list_of_lists_recall_visible, f'lcg_{delta}/lgc_recall_visible_per_class_{delta}', colors)
    plot_scores_per_class("Recall unshown", list_of_lists_recall_unshown, f'lcg_{delta}/lgc_recall_unshown_per_class_{delta}', colors)
    plot_scores_per_class("F1 Score", list_of_lists_f1_score, f'lcg_{delta}/lgc_f1_score_per_class_{delta}', colors)
    plot_scores_per_class("F1 Score visible", list_of_lists_f1_score_visible, f'lcg_{delta}/lgc_f1_score_visible_per_class_{delta}', colors)
    plot_scores_per_class("F1 Score unshown", list_of_lists_f1_score_unshown, f'lcg_{delta}/lgc_f1_score_unshown_per_class_{delta}', colors)
    
    file = open(f'lcg_{delta}/lgc_class_tables_{delta}.txt', 'w')
