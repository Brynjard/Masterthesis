...
def compute_precision_recall_curve(targets, closests, detections, delta):
    ...
    #     true_positive[:,i] = true_positive[index_sort, i]
    #     false_positive[:,i] = false_positive[index_sort, i]
    #     false_negative[:,i] = false_negative[index_sort, i]
    ...
    #     true_positive_visible[:,i] = true_positive_visible[index_sort, i]
    #     false_positive_visible[:,i] = false_positive_visible[index_sort, i]
    #     false_negative_visible[:,i] = false_negative_visible[index_sort, i]
    ...
    #     true_positive_unshown[:,i] = true_positive_unshown[index_sort, i]
    #     false_positive_unshown[:,i] = false_positive_unshown[index_sort, i]
    #     false_negative_unshown[:,i] = false_negative_unshown[index_sort, i]
