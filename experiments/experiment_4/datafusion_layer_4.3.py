...
from event_relation_timing import event_time_past_ex4_3, event_time_future_ex4_3, calculate_time_between_events
...
if __name__ == '__main__':
    ...
    for event in event_time_future_ex4_3.keys():
        for associated_event in event_time_future_ex4_3[event].keys():
            event_time_future_ex4_3[event][associated_event] = median(event_time_future_ex4_3[event][associated_event])
    
    for event in event_time_past_ex4_3.keys():
        for associated_event in event_time_past_ex4_3[event].keys():
            event_time_past_ex4_3[event][associated_event] = median(event_time_past_ex4_3[event][associated_event])

    prediction_dict = data_fusion(prev_model, current_model, next_model, timeframe, event_time_future_ex4_3, event_time_past_ex4_3)
